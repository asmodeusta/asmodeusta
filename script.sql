...
create table usf_permissions
(
    module    int                  not null,
    operation varchar(255)         not null,
    role      int                  not null,
    view      tinyint(1) default 0 not null,
    `create`  tinyint(1) default 0 not null,
    edit      tinyint(1) default 0 not null,
...
(
    ...
    parent      int                  not null,
    active      tinyint(1) default 1 not null,
    constraint usf_user_roles_slag_uindex
        unique (slag)
);
